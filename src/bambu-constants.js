...
export const CURRENT_STAGE_IDS = {
  ...
  '1' : {
    key: 'auto_bed_leveling',
    text: 'Auto bed leveling'
  },
  '2' : {
    key: 'heatbed_preheating',
    text: 'Preheating heatbed'
  },
  '3' : {
    key: 'sweeping_xy_mech_mode',
    text: 'Sweeping XY mech mode'
  },
  '4' : {
    key: 'changing_filament',
    text: 'Changing filament'
  },
  '5' : {
    key: 'm400_pause',
    text: 'Paused'
  ...
  '6' : {
    key: 'paused_filament_runout',
    text: 'Paused. Filament runout detected'
  },
  '7' : {
    key: 'heating_hotend',
    text: 'Heating hotend'
  ...
  '8' : {
    key: 'calibrating_extrusion',
    text: 'Calibrating extrusion'
  },
  '9' : {
    key: 'scanning_bed_surface',
    text: 'Scanning bed surface'
  },
  '10' : {
    key: 'inspecting_first_layer',
    text: 'Inspecting first layer'
  },
  '11' : {
    key: 'identifying_build_plate_type',
    text: 'Identifying build plate'
  },
  '12' : {
    key: 'calibrating_micro_lidar', // DUPLICATE?
    text: 'Calibrating micro lidar'
  },
  '13' : {
    key: 'homing_toolhead',
    text: 'Homing'
  ...
  '14' : {
    key: 'cleaning_nozzle_tip',
    text: 'Cleaning nozzle tip'
  },
  '15' : {
    key: 'checking_extruder_temperature',
    text: 'Checking extruder temperature'
  },
  '16' : {
    key: 'paused_user',
    text: 'Paused by user'
  ...
  '17' : {
    key: 'paused_front_cover_falling',
    text: 'Paused. Front cover fell'
  },
  '18' : {
    key: 'calibrating_micro_lidar', // DUPLICATE?
    text: 'Calibrating micro lidar'
  ...
  '19' : {
    key: 'calibrating_extrusion_flow',
    text: 'Calibrating extrusion flow'
  },
  '20' : {
    key: 'paused_nozzle_temperature_malfunction',
    text: 'Paused. Nozzle temperature malfunction'
  },
  '21' : {
    key: 'paused_heat_bed_temperature_malfunction',
    text: 'Paused. heatbed temperature malfunction'
  },
  '22' : {
    key: 'filament_unloading',
    text: 'Unloading Filament'
  },
  '23' : {
    key: 'paused_skipped_step',
    text: 'Paused. Skipped step'
  },
  '24' : {
    key: 'filament_loading',
    text: 'Loading filament'
  },
  '25' : {
    key: 'calibrating_motor_noise',
    text: 'Calibrating motor noise'
  },
  '26' : {
    key: 'paused_ams_lost',
    text: 'Paused. AMS lost'
  },
  '27' : {
    key: 'paused_low_fan_speed_heat_break',
    text: 'Paused. Low fan speed heat break'
  },
  '28' : {
    key: 'paused_chamber_temperature_control_error',
    text: 'Paused. Chamber temperature control error'
  },
  '29' : {
    key: 'cooling_chamber',
    text: 'Cooling chamber'
  },
  '30' : {
    key: 'paused_user_gcode',
    text: 'Paused. User gcode'
  },
  '31' : {
    key: 'motor_noise_showoff',
    text: 'Motor noise showoff'
  },
  '32' : {
    key: 'paused_nozzle_filament_covered_detected',
    text: 'Paused. Filament covering nozzle'
  },
  '33' : {
    key: 'paused_cutter_error',
    text: 'Paused. Cutter error'
  },
  '34' : {
    key: 'paused_first_layer_error',
    text: 'Paused. First layer error'
  },
  '35' : {
    key: 'paused_nozzle_clog',
    text: 'Paused. Nozzle clog'
  },
...
export const SPEED_PROFILE = {
  '1': {label:'Silent', icon:mdiSpeedometerSlow},
  '2': {label:'Standard', icon:mdiSpeedometerMedium},
  '3': {label:'Sport', icon:mdiSpeedometer},
  '4': {label:'Ludicrous', icon:mdiSkullCrossbones},
}

export const FILAMENT_NAMES = {
  'default': 'Unknown',
  'GFB00': 'Bambu ABS',
  'GFB01': 'Bambu ASA',
  'GFN03': 'Bambu PA-CF',
...
export const PRINT_ERROR_ERRORS = {
